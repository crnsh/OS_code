...
// Function for sorting according to priority
void priority_bsortDesc(process *list, int s)
{
   int i, j;
   process temp;
...
int main(void) {
    ...
    // Sorted according to priority from high to low
    priority_bsortDesc(processes, n);
